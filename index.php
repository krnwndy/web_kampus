    ...
    <div class="container-fluid">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4">
            <a href="/" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
                ...
                <b class="ml-3 p-2">UTM MATARAM</b>
            </a>

            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li><a href="index.php" class="nav-link px-2 text-dark fw-bold text-decoration-none">Home</a></li>
                <li><a href="index.php?hal=data_mahasiswa"
                        class="nav-link px-2 text-black fw-bold text-decoration-none">Data Mahasiswa</a></li>
                <li><a href="index.php?hal=data_mata_kuliah"
                        class="nav-link px-2 text-black fw-bold text-decoration-none">Data Mata Kuliah</a></li>
                <li><a href="index.php?hal=data_prodi"
                        class="nav-link px-2 text-black fw-bold text-decoration-none ">Data Prodi</a></li>
                <li><a href="index.php?hal=data_dosen"
                        class="nav-link px-2 text-black fw-bold text-decoration-none ">Data Dosen</a></li>
            </ul>
